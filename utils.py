...
class GenerationMixin:
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        all_uncertainty = torch.zeros(num_beams, dtype=torch.float, device=input_ids.device)
        ...
        while True:
            ...
            print("all_uncertainty",all_uncertainty)
        ...
        # uncertainty_per_token=-1
        # select_uncertainty = -2
        print("sequence_outputs",sequence_outputs)
        select_idx = torch.nonzero(torch.ne(sequence_outputs["beam_indices"],-1))[-1]
        beam_id = sequence_outputs["beam_indices"][select_idx[0]][select_idx[1]]
        select_uncertainty = all_uncertainty[beam_id]
        uncertainty_per_token = select_uncertainty / num_token
        print("select_uncertainty",select_uncertainty)
        print("uncertainty_per_token",uncertainty_per_token)
        ...
        if return_dict_in_generate:
            ...
            if self.config.is_encoder_decoder:
                ...
                return BeamSearchDecoderOnlyOutput(
                    ...
                    attentions=decoder_attentions,
                    hidden_states=decoder_hidden_states,
                ),select_uncertainty,uncertainty_per_token
        else:
